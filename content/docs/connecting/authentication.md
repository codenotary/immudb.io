...
weight: 250
aliases: ["/master/connecting/authentication/", "/connecting/authentication/"]
---
## With credentials
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/connect-with-auth/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/connect-with-mtls/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/connect-with-no-auth/main.go" >}}
{{% /tab %}}
