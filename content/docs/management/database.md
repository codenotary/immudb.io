...
weight: 280
aliases: ["/master/management/database/", "/management/database/"]
---
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/database-create/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/database-list/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/database-load-unload/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/database-settings/main.go" >}}
{{% /tab %}}
