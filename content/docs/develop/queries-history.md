...
weight: 310
aliases: ["/master/develop/queries-history/", "/develop/queries-history/"]
---
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-history/main.go" >}}
{{% /tab %}}
...
{{< snippet "/code-examples/go/develop-kv-scan/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-references/main.go" >}}

Example with verifications

{{< snippet "/code-examples/go/develop-kv-references-verified/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-references-get/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-references-txid/main.go" >}}
{{% /tab %}}
