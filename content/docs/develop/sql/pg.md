...
weight: 550
aliases: ["/master/develop/sql/pg/", "/develop/sql/pg/"]
---
...
- **immudb-only extensions**: see [SQL Diff Query](/docs/develop/sql/sqldiff/) for transaction-range table diffs against the immutable transaction log
