...
title: "Querying"
weight: 440
aliases: ["/master/develop/sql/querying/", "/develop/sql/querying/"]
---
...
immudb can be configured to inject request information (**user**, **ip address**, etc...) to transaction metadata (see [Request Metadata](/docs/production/request-metadata/)). When this functionality is enabled,
