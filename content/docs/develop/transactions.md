...
title: "Transactions"
weight: 330
aliases: ["/master/develop/transactions/", "/develop/transactions/"]
---
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-getall/main.go" >}}
{{% /tab %}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-setall/main.go" >}}
{{% /tab %}}
...
* `Op_ZAdd`: [ZAdd](/docs/develop/indexes/#sorted-sets) option element
* `Op_Ref`: [Reference](/docs/develop/queries-history/#references) option element
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-execall/main.go" >}}
{{% /tab %}}
...
{{< snippet "/code-examples/go/develop-kv-txscan/main.go" >}}
...
{{% tab "Go" %}}
{{< snippet "/code-examples/go/develop-kv-txfilter/main.go" >}}
{{% /tab %}}
