...
title: "Go Samples"
weight: 70
aliases: ["/master/samples/go/", "/samples/go/"]
---
...
In order to run this sample, immudb server must be already running. This step is quite simple and it's described at [Running immudb](/docs/running/download/).
