...
weight: 180
aliases: ["/master/production/performance-guide/", "/production/performance-guide/"]
---
...
immudb offers [replication](/docs/production/replication/) mechanism where replicas follow the leader
...
and multiple replication levels (like [replicas of replicas](/docs/production/replication/#replica-of-a-replica)).
...
immudb can be easily [embedded](/docs/embedded/embedding/) into other golang applications.
