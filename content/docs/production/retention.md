...
title: "Retention"
weight: 190
aliases: ["/master/production/retention/", "/production/retention/"]
---
## Data Retention
...
2. In a new terminal, use the [`immuadmin`](/docs/connecting/clitools/) command to create a database on the immudb server:
...
3. Alternatively, you can use the [`immuadmin`](/docs/connecting/clitools/) command to truncate an existing database which has not been setup with retention period:
