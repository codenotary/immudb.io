...
weight: 180
aliases: ["/master/production/performance-guide/"]
---
...
immudb offers [replication](/production/replication/) mechanism where replicas follow the leader
...
and multiple replication levels (like [replicas of replicas](/production/replication/#replica-of-a-replica)).
...
immudb can be easily [embedded](/embedded/embedding/) into other golang applications.
