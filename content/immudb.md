...
immudb can be run as full database server with [replicas](/production/replication/) or easily [embedded](/embedded/embedding/) as a lightweight database into application.
...
Check [auditor](/production/auditor/) section for additional details.
