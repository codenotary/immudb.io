...
title: "Transactions"
weight: 330
aliases: ["/master/develop/transactions/"]
---
...
* `Op_ZAdd`: [ZAdd](/develop/indexes/#sorted-sets) option element
* `Op_Ref`: [Reference](/develop/queries-history/#references) option element
