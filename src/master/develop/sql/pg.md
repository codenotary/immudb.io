...
>Note: immudb supports the pgsql wire protocol. It is *not* compatible with the SQL dialect. Check other sections in the `Develop with SQL` section to see what queries and operations are supported.
>
